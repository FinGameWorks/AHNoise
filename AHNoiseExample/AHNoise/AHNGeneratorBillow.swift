...
public class AHNGeneratorBillow: AHNGenerator {
  ...
  /**
   Creates a new `AHNGeneratorBillow` object.
  ...
  public init(context: AHNContext, textureWidth width: Int, textureHeight height: Int, use4DNoise: Bool, mapForSphere: Bool, makeSeamless: Bool){
    super.init(functionName: "billowGenerator", context: context, textureWidth: width, textureHeight: height, use4DNoise: use4DNoise, mapForSphere: mapForSphere, makeSeamless: makeSeamless)
  }
